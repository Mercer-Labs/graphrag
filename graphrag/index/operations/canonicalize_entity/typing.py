...
CanonicalizationStrategy = Callable[
    [
        ...
        dict[str, Any] | None,  # current_entity_attributes
        list[str],  # relationship_descriptions
        dict[str, dict[str, Any]],  # candidate_map (map of candidate ID to dict with id, title, description, attributes, relationship_descriptions)
        PipelineCache,
        StrategyConfig,
    ],
